...
const testimonials = [
  {
    ...
    quote:
      "I've been coming to Crown & Glory Salon for over a year now, and I'm always impressed with their hair coloring services. The stylists understand exactly what I want!",
    rating: 5,
  },
  {
    id: 2,
      ...
      <div className="container-custom relative z-10">
        <div className="salon-section-title">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Don't just take our word for it. Here's what our clients have to say about their experiences at Crown & Glory Salon.
          </p>
        </div>
