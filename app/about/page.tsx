...
export const metadata: Metadata = {
  title: "About Us - Crown & Glory Salon",
  description: "Learn about Crown & Glory Salon's history, mission, and our team of expert stylists.",
}
    ...
    <>
      <div className="bg-gradient-to-r from-primary to-primary-light py-20 mb-12">
        <div className="container-custom">
          <h1 className="heading-xl text-white text-center mb-4">About Crown & Glory Salon</h1>
      ...
      <div className="container-custom mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Founded in 2010, Crown & Glory Salon has been at the forefront of beauty and style in Cleveland, Ohio. Our journey began
          ...
          <div className="relative h-[400px] rounded-lg overflow-hidden">
            <Image
              ...
              alt="Crown & Glory Salon Interior"
              fill
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            At Crown & Glory Salon, our mission is to enhance the natural beauty of every client, boost their confidence, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="salon-card text-center p-6">
                ...
                <Link href="/booking" className="text-primary hover:text-accent transition-colors">
        ...
        <div className="text-center">
          <h2 className="heading-lg mb-6">Experience the Crown & Glory Difference</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            We invite you to visit Crown & Glory Salon and experience our commitment to beauty, style, and exceptional service
            firsthand.
          </p>
